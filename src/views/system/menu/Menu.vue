        ...
        >
            ...
            >
                ...
                <a-tree
                    ...
                    :data="menuList"
                    block-node
                    v-mode:selected-keys="treeSelectedKeys"
            ...
            <div class="menu-detail tw-px-5 tw-flex-1 tw-flex-grow-[4]">
                ...
                >
                    ...
                    <a-button-group
                        class="tw-ml-auto"
                        v-if="currentMenuType !== MenuType.Root"
                    >
                        <a-button
                            size="small"
                            :type="
                            ...
                            "
                            v-if="currentMenuType !== MenuType.Button"
                            @click="onAddMenu"
                        >
                ...
                <div>
                    ...
                    <a-breadcrumb class="!tw-text-body-1 tw-mb-4">
                        <a-breadcrumb-item
                            v-for="item in selectedMenuDetail"
                            :key="item.name"
                        >
                ...
                <NaForm
                    ...
                    :default-form-col-props="menuDetailFormColProps"
                    :formInputItems="currentFormInputItems"
                    :default-form-label-props="menuDetailFormLabelProps"
                    :form-props="menuFormProps"
                    :default-form-row-props="menuDetailFormRowProps"
                    v-bind:default-form-action-button-col-props="menuFormBtnColProps"
